...
const Property_Details = ({ children: slides, autoSlide = false, autoSlideInterval = 3000 }) => {
          ...
          <div className="container">
            <div className=" row g-3 tw-py-8">
              <div className="col-md-6">
                <h3 style = {{color: 'white'}}>Luxury Apartments on California.</h3>

                <div className=" tw-mt-4 tw-flex tw-gap-4 tw-items-center">
                <button className=" tw-bg-primary tw-text-white tw-px-4 tw-text-sm tw-rounded-full  tw-py-1">FOR SALE</button>
                <button className="  tw-bg-primary tw-text-white tw-px-4 tw-text-sm tw-rounded-full  tw-py-1"> Apartment Id: 475</button>
                <button className=" tw-bg-primary tw-text-white tw-px-4 tw-text-sm tw-rounded-full  tw-py-1"> Available Status: Available</button>
                </div>
              ...
              <div className="col-md-6 tw-float-right">
                <div className="row">
                  ...
                  <p className="  tw-flex tw-items-center tw-gap-3 tw-m-0 tw-text-gray   tw-px-4 tw-py-1">
                    {' '}
                    <IoLocationOutline size={30} /> SKOLGATAN 2 LGH 1402, 22361 LUND, LUND, SWEDEN
                  </p>
                ...
                <div className=" p-4 tw-bg-white tw-rounded-2xl">
                  <div className=" tw-w-full">
                    <div className="tw-overflow-hidden  tw-rounded-2xl tw-relative">
                      <div className="tw-flex tw-transition-transform tw-ease-out tw-duration-500 tw-h-screen	 tw-w-full" style={{ transform: `translateX(-${curr * 100}%)` }}>
                        {/* {sliders?.map((s) => (
    <> */}
                        <div className=" tw-flex-none  tw-w-full tw-h-full tw-relative">
                          <img src={san} alt="" className=" tw-w-full tw-h-full  tw-object-cover" />
                        </div>
                        <div className=" tw-flex-none  tw-w-full tw-h-full tw-relative">
                          <img src={san2} alt="" className=" tw-w-full tw-h-full  tw-object-cover" />
                        </div>
                        <div className=" tw-flex-none  tw-w-full tw-h-full tw-relative">
                          <img src={san} alt="" className=" tw-w-full tw-h-full  tw-object-cover" />
                        </div>
                      ...
                      <div className=" tw-absolute tw-top-6 tw-left-5 tw-gap-4  tw-flex  ">
                        <button onClick={prev} className="tw-p-1.5 tw-rounded-full tw-shadow tw-bg-white/80 tw-text-gray-800 tw-hover:bg-white">
                          <LiaAngleLeftSolid size={30} className=" tw-text-blue" />
                        </button>
                        <button onClick={next} className="tw-p-1.5 tw-rounded-full tw-shadow tw-bg-white/80 tw-text-gray-800 tw-hover:bg-white">
            ...
            <div className="row">
              <div className=" ">
                ...
                <div className=" tw-rounded-2xl tw-my-6 p-4 tw-shadow-lg tw-bg-white">
                  ...
                  <p className=" tw-text-gray tw-mt-5">Risk management and compliance, when approached strategically, have the potential to go beyond mitigating threats.</p>
