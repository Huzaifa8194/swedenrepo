            ...
            <div className="row g-4">
              <div className="col-md-8 tw-py-12 tw-bg-white tw-text-justify">
                <div className="  2xl:tw-pl-[21.3%] md:tw-pl-[14.5%] tw-pl-3 tw-pr-[3.5%]">
                  ...
                  <p className=" tw-text-gray">
                    Following are 6 reasons why Sweden is considered an ideal
                    place to study:
                  </p>
                  ...
                  <div>
                    ...
                    <p className=" tw-text-gray">
                      Study in Sweden let you think independently and
                  ...
                  <div>
                    <div>
                      ...
                      <p className=" tw-text-gray">
                        Sweden has contributed a lot to the history books, and
                      ...
                      <p className=" tw-text-gray">
                        Using Swedish, a rich and beautiful native language; in
                        ...
                        many more that can take you anywhere you want to go.
                      </p>
                      ...
                      <p className=" tw-text-gray">
                        Malmö is among the top cities in Sweden having a free
                        ...
                        is in the 139th place of all 248 Teleport cities.
                      </p>
                      ...
                      <p className=" tw-text-gray">
                        International students can comfortably get Sweden work
                        ...
                        Swedish is necessary – it’s often a job’s requirement.)
                      </p>
                      ...
                      <p className=" tw-text-gray">
                        Unless you are a citizen of a neighboring Nordic
                      ...
                      <p className=" tw-text-gray">
                        If you are thinking about relocation Sweden; want to
                    ...
                    <p className=" tw-text-gray">
                      Students from the EU/EEA can study in Sweden without any
                      visa requirements. If you are from outside the EU/EEA, you
                      may need to obtain a student visa.
                    </p>
                    <br />
                    <span className=" tw-pt-3 tw-flex tw-items-center tw-gap-2">
                      {" "}
                    ...
                    <p className=" tw-text-gray">
                      Sweden is home to several internationally successful
                      ...
                      for foreign nationals looking to join the local workforce.
                    </p>
                    ...
                    <div className=" row tw-pt-5">
                      <div className="col-md-6">
                        ...
                        <p className="  tw-text-gray">
                          Application for <b>online first admission</b> of
                          bachelor’s regarding different programs starts from{" "}
                          <b>16th of October to 15th of January</b> every year.
                          After enrolling, the classes start in August.
                        </p>

                        <p className="  tw-text-gray">
                          Application for <b>online second admission</b> of
                          bachelor’s regarding different programs starts from{" "}
                          <b>1st of June to 15th of August</b> of every year.
                    ...
                    <div>
                      ...
                      <p className=" tw-text-gray">
                        There are no requirements of the language test such as
                    ...
                    <div>
                      ...
                      <ul className=" tw-p-0 tw-pt-4">
                        ...
                        <li className=" tw-flex tw-items-center tw-gap-3">
                          <GoTriangleRight className=" tw-text-blue" />
                          <p className=" m-0 tw-text-gray">
                            English Language with Proficiency Certificate from
                            Cambridge Michigan.
                          </p>
                        </li>
                      ...
                      <p className=" tw-text-gray">
                        Use our <b>Student Assessment tool </b> to find out if
                      ...
                      <div>
                        ...
                        <p className=" tw-text-gray">
                          Denmark boasts an advanced educational system with
                          ...
                          and bachelor’s degrees in business-related fields.
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className=" tw-text-gray">
                          In Denmark requirements vary from programme to
                      ...
                      <div>
                        ...
                        <p className=" tw-text-gray">
                          All higher education programmes in Denmark require a
                        ...
                        <p className=" tw-text-gray">
                          To prove a satisfactory proficiency in English, the
                      ...
                      <div>
                        ...
                        <p className=" tw-text-gray">
                          Applicants who are native English speakers must also
                      ...
                      <div>
                        ...
                        <p className=" tw-text-gray">
                          In order to gain admission to an undergraduate program
                        ...
                        <p className="  tw-text-gray">
                          You will need to take an admission test and an
                          interview if required by the course. So it will be
                          advised for some early preparation
                        </p>
                        ...
                        <p className=" tw-text-gray">
                          As per the qualification guidelines provided by the UK
                          National Agency, universities assess your application
                          before offering a place on the course.
                        </p>
                        <ul className=" tw-p-0 tw-pt-4">
                          <li className=" tw-flex  tw-gap-3">
                            ...
                            <p className=" m-0 tw-text-gray">
                              At least two subjects to be taken at A2. Sometimes
                          ...
                          <li className=" tw-flex  tw-gap-3">
                            ...
                            <p className=" m-0 tw-text-gray">
                              Many universities appreciate The Extended Project
                              (EPQ) though it is not compulsory
                            </p>
                          </li>
                          <li className=" tw-flex tw-items-center tw-gap-3">
                            <div>
                          ...
                          <li className=" tw-flex t tw-gap-3">
                            ...
                            <p className=" m-0 tw-text-gray">
                              SI-UK provides IELTS preparation classes so you
                              can hit your target score. Sign up for the right
                              IELTS course that suits your schedule.
                            </p>
                          </li>
                          <li className=" tw-flex tw-items-center tw-gap-3">
                            <GoTriangleRight className=" tw-text-blue" />
                          ...
                          <li className=" tw-flex tw-gap-3">
                            ...
                            <p className=" m-0 tw-text-gray">
                              A fitness to practice check as well as finance
                              check
                            </p>
                          </li>
                          <li className=" tw-flex  tw-gap-3">
                      ...
                      <div>
                        ...
                        <p className=" tw-text-gray">
                          The basic condition for entering studies is the
                        ...
                        <p className=" tw-text-gray">
                          If you want to study at university in the Czech
                        ...
                        <p className=" tw-text-gray">
                          Besides certified copies of your educational
                          ...
                          portfolio, English proficiency test)
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className=" tw-text-gray">
                          Applications and admissions to higher education in
                          Norway is handled by each institution, and the
                          different institutions may have different requirements
                          and deadlines.
                        </p>
                        <p className=" tw-text-gray">
                          Make sure you obtain all necessary information about
                      ...
                      <div>
                        ...
                        <p className=" tw-text-gray">
                          Some study programmes have special admission
                        ...
                        <p className=" tw-text-gray">
                          Applicants for Masters programmes have normally
                      ...
                      <div>
                        ...
                        <br />
                        <p className=" tw-text-gray">
                          For courses where the language of instruction is
                          ...
                          required by different institutions.
                        </p>
                        <p className=" tw-text-gray">
                          For courses where the language of instruction is
                          Norwegian, proficiency in the Norwegian language is
                          required and should be documented.
                        </p>
                        <p className=" tw-text-gray">
                          Learn Norwegian outside Norway
                        </p>
                        <p className=" tw-text-gray">
                          Even though your study programme is taught in English
                          a certain knowledge of the Norwegian language will
                          help you both academically, but also socially.
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className=" tw-text-gray">
                          Applying for higher education degree studies in
                        ...
                        <p className=" tw-text-gray">
                          If you are a non-EU student and subject to tuition
                      ...
                      <div>
                        ...
                        <p className=" tw-text-gray">
                          Applications for bachelor’s and master’s programmes
                          ...
                          even earlier. It depends on the university!
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className=" tw-text-gray">
                          When applying for bachelor’s programmes, you usually
                          ...
                          higher education studies after that.
                        </p>
                        <p className=" tw-text-gray">
                          For master’s level admissions, you need to have
                          completed a university-level bachelor’s degree, or
                          equivalent.
                        </p>
                        <p className=" tw-text-gray">
                          The eligibility requirements may vary from one-degree
                        ...
                        <p className=" tw-text-gray">
                          If English is not your first language, you may need to
                      ...
                      <div>
                        ...
                        <p className=" tw-text-gray">
                          After the application period and any entrance exams
                          ...
                          available in the Studyinfo.fi programme description.
                        </p>
                        <p className=" tw-text-gray">
                          Once you have been accepted as a student, you will
