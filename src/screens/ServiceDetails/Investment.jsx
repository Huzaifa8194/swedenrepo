              ...
              >
                <div className="   2xl:tw-pl-[21.3%] md:tw-pl-[14.5%] tw-pl-3 tw-pr-[3.5%]">
                  ...
                  <span className=" tw-flex tw-items-center tw-gap-2">
                    {" "}
                    <p className=" tw-m-0 tw-w-[15px]  tw-h-[1px] tw-bg-[#c2c2d3]"></p>{t(`Investment`)}</span>

                  <h2 className="tw-text-left">
                    <strong>{t(`Oppurtunities in Sweden`)}</strong>
                  </h2>
                  <br />
                  <p className="  tw-text-gray">{t(`Swedish market has been witnessing the growing number of
                    ...
                    investors are attracted to the country’s growing economy.`)}</p>
                  ...
                  <h2 className="tw-text-left">
                    <strong>{t(`To Look For Business Opportunities In Sweden, Which Are:`)}</strong>
                  </h2>
                  <br />

                  <span className=" tw-pt-3 tw-flex tw-items-center tw-gap-2">
                    {" "}
                    <p className=" tw-m-0 tw-w-[15px]  tw-h-[1px] tw-bg-[#c2c2d3]"></p>{t(`DO THE`)}</span>
                  <h2 className="tw-text-left">
                    <strong>{t(`Required Research`)}</strong>
                  </h2>
                  <br />
                  ...
                  <p className=" tw-text-gray">{t(`You can also check with the trade organization to get
                    ...
                    and general stats of the market.`)}</p>

                  <br />
                  <span className=" tw-pt-3 tw-flex tw-items-center tw-gap-2">
                    {" "}
                    <p className=" tw-m-0 tw-w-[15px]  tw-h-[1px] tw-bg-[#c2c2d3]"></p>{t(`BUILD`)}</span>
                  <h2 className="tw-text-left">
                    <strong>{t(`Your Network`)}</strong>
                  </h2>
                  ...
                  <p className=" tw-text-gray">{t(`The key to a successful start-up or business is to build
                    ...
                    businesses in Sweden to expand their network.`)}</p>
                  ...
                  <div className="row tw-flex tw-items-center">
                    ...
                    <div className="col-md-6">
                      <span className=" tw-pt-3 tw-flex tw-items-center tw-gap-2">
                        {" "}
                        <p className=" tw-m-0 tw-w-[15px]  tw-h-[1px] tw-bg-[#c2c2d3]"></p>{t(`FRANCHISE`)}</span>

                      <h2 className="tw-text-left">
                        <strong>{t(`Or Business`)}</strong>
                      </h2>
                      <br />
                  ...
                  <span className=" tw-pt-3 tw-flex tw-items-center tw-gap-2">
                    {" "}
                    <p className=" tw-m-0 tw-w-[15px]  tw-h-[1px] tw-bg-[#c2c2d3]"></p>{t(`GO`)}</span>
                  <h2 className="tw-text-left">
                    <strong>{t(`For It`)}</strong>
                  </h2>
                  <br />
                  ...
                  <p className=" tw-text-gray">{t(`When you have collected all the details and made your mind
                    ...
                    might be a big fish in a small pond.`)}</p>
                  <p className=" tw-text-gray">{t(`Sweden’s strong finances, political stability, sound banking
                    ...
                    investors should consider before investing in Sweden.`)}</p>

                  <br />

                  <span className=" tw-pt-3 tw-flex tw-items-center tw-gap-2">
                    {" "}
                    <p className=" tw-m-0 tw-w-[15px]  tw-h-[1px] tw-bg-[#c2c2d3]"></p>{t(`INVEST IN`)}</span>
                  <h2 className="tw-text-left">
                    <strong>{t(`SWEDISH REAL ESTATE`)}</strong>
                  </h2>
                  <br />
                  ...
                  <span className=" tw-pt-3 tw-flex tw-items-center tw-gap-2">
                    {" "}
                    <p className=" tw-m-0 tw-w-[15px]  tw-h-[1px] tw-bg-[#c2c2d3]"></p>{t(`INVESTMENT IN`)}</span>
                  <h2 className="tw-text-left">
                    <strong>{t(`Swedish Real Estate Makes A Great Profit`)}</strong>
                  </h2>
                  <br />
                  ...
                  <p className=" tw-text-gray">{t(`Sweden has experienced a growth in foreign investment in its
                    ...
                    areas to do business in the Scandinavian region.`)}</p>
                  ...
                  <div className="row tw-flex tw-items-center">
                    <div className="col-md-6">
                      <span className=" tw-pt-3 tw-flex tw-items-center tw-gap-2">
                        ...
                        <p className=" tw-m-0 tw-w-[15px]  tw-h-[1px] tw-bg-[#c2c2d3]"></p>{t(`INVEST IN`)}</span>
                      <h2 className="tw-text-left">
                        <strong>{t(`DIGITAL TECHNOLOGIES`)}</strong>
                      </h2>
                      <br />
                      ...
                      <p className=" tw-text-gray">{t(`Sweden is a launch pad for going digital as gamechanging
                        ...
                        a connected, low-carbon future.`)}</p>
                    </div>
                    <div className="col-md-6">
                      <div className="row ">
                        <div className="col-md-12 tw-mx-auto">
                  ...
                  <span className=" tw-pt-3 tw-flex tw-items-center tw-gap-2">
                    {" "}
                    <p className=" tw-m-0 tw-w-[15px]  tw-h-[1px] tw-bg-[#c2c2d3]"></p>{t(`MARKETS`)}</span>
                  <h2 className="tw-text-left">
                    <strong>{t(`SWEDEN DIGITAL TECHNOLOGIES`)}</strong>
                  </h2>
                  <br />
                  ...
                  <p className=" tw-text-gray">{t(`When it comes to using digital technologies to foster
                    ...
                    in the capital city Stockholm.`)}</p>
                  <p className=" tw-text-gray">{t(`As a result, leading tech companies have established their
                    ...
                    have invested heavily in Sweden.`)}</p>

                  <br />
                  <span className=" tw-pt-3 tw-flex tw-items-center tw-gap-2">
                    {" "}
                    <p className=" tw-m-0 tw-w-[15px]  tw-h-[1px] tw-bg-[#c2c2d3]"></p>{t(`SMART`)}</span>
                  <h2 className="tw-text-left">
                  ...
                  <p className=" tw-text-gray">{t(`Sweden is at the forefront of the global race toward
                    ...
                    practices across industrial ecosystems and value chains.`)}</p>
                  <p className=" tw-text-gray">{t(`Sustainability, innovation and productivity are key
                    ...
                    cent of the nation’s GDP.`)}</p>

                  <br />
                  <span className=" tw-pt-3 tw-flex tw-items-center tw-gap-2">
                    {" "}
                    <p className=" tw-m-0 tw-w-[15px]  tw-h-[1px] tw-bg-[#c2c2d3]"></p>{t(`FOOD`)}</span>
                  <h2 className="tw-text-left">
                    <strong>{t(`INDUSTRY`)}</strong>
                  </h2>
                  <br />
                  ...
                  <p className=" tw-text-gray">{t(`Choosing a sustainable lifestyle, including the food you
                    ...
                    and job creation across the country.`)}</p>

                  <br />
                  <span className=" tw-pt-3 tw-flex tw-items-center tw-gap-2">
                    {" "}
                    <p className=" tw-m-0 tw-w-[15px]  tw-h-[1px] tw-bg-[#c2c2d3]"></p>{t(`GOING`)}</span>
                  <h2 className="tw-text-left">
                    <strong>{t(`PLANT-BASED`)}</strong>
                  </h2>
                  <br />
                  ...
                  <p className=" tw-text-gray tw-font-medium">{t(`OTHER WAYS TO INVEST IN SWEDEN ARE AS FOLLOWS`)}</p>

                  <br />
                  <span className=" tw-pt-3 tw-flex tw-items-center tw-gap-2">
                    {" "}
                    <p className=" tw-m-0 tw-w-[15px]  tw-h-[1px] tw-bg-[#c2c2d3]"></p>{t(`OPEN A`)}</span>
                  <h2 className="tw-text-left">
                    <strong>{t(`Boutique`)}</strong>
                  </h2>
                  <br />
                  ...
                  <p className=" tw-text-gray">{t(`Boutique business is one of the thriving small-scale
                    ...
                    Gant, WESC, Filippa K, and Nakkna within its borders.`)}</p>
                  <p className=" tw-text-gray">{t(`All that is required to launch this type of business is a
                    ...
                    struggle to attract customers.`)}</p>

                  <br />
                  <span className=" tw-pt-3 tw-flex tw-items-center tw-gap-2">
                    {" "}
                    <p className=" tw-m-0 tw-w-[15px]  tw-h-[1px] tw-bg-[#c2c2d3]"></p>{t(`RETAIL OF`)}</span>
                  <h2 className="tw-text-left">
                    <strong>{t(`Shoes, Sandals, Slippers And Belts`)}</strong>
                  </h2>
                  <br />
                  ...
                  <p className=" tw-text-gray">{t(`So, if you are looking towards leveraging on the big market
                    ...
                    leather works as it relates to fashion.`)}</p>
                  ...
                  <p className=" tw-text-gray">{t(`This type of business is simple to start and it is also easy
                    ...
                    won’t struggle to make daily sales.`)}</p>

                  <br />
                  <span className=" tw-pt-3 tw-flex tw-items-center tw-gap-2">
                    {" "}
                    <p className=" tw-m-0 tw-w-[15px]  tw-h-[1px] tw-bg-[#c2c2d3]"></p>{t(`RETAILING OF`)}</span>
                  <h2 className="tw-text-left">
                    <strong>{t(`Jewelries And Fashion Accessories`)}</strong>
                  </h2>
                  <br />
                  ...
                  <p className=" tw-text-gray">{t(`If you have cash and you are looking for a viable
                    ...
                    rings, earrings, bangles, ribbons, hairband et al.`)}</p>
                  ...
                  <span className=" tw-pt-3 tw-flex tw-items-center tw-gap-2">
                    ...
                    <p className=" tw-m-0 tw-w-[15px]  tw-h-[1px] tw-bg-[#c2c2d3]"></p>{t(`OPEN A`)}</span>
                  <h2 className="tw-text-left">
                    <strong>{t(`Consignment Shop`)}</strong>
                  </h2>
                  <br />
                  ...
                  <p className=" tw-text-gray">{t(`As a matter of fact, there is a large market for secondhand
                    ...
                    ideal place to start this type of business in Sweden.`)}</p>
                  ...
                  <p className=" tw-text-gray">{t(`So, if you are looking towards starting a small- scale
                    ...
                    options is to open a wedding shop`)}</p>
                  ...
                  <p className=" tw-text-gray">{t(`Swedish traditional dishes, some of which are hundreds of
                    ...
                    adopts many international dishes.`)}</p>
                  ...
                  <p className=" tw-text-gray">{t(`If you are an investor who is interested and is either
                    living abroad or in Sweden, you can feel free to contact us`)}</p>
