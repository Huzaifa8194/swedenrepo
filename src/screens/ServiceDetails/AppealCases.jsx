                ...
                <div className=" 2xl:tw-pl-[21.3%] md:tw-pl-[14.5%] tw-pl-3 tw-pr-[3.5%]">
                  <div>
                    ...
                    <p className="tw-text-gray">
                      If you are seeking asylum in Sweden, understanding the
                      legal process and meeting requirements can be
                      overwhelming. At [Your Company Name], our team of
                    ...
                    <ul className="tw-p-0 tw-pl-0">
                      <li>
                        <p className="m-0 tw-text-gray">
                          Our specialists simplify complex legal requirements,
                    ...
                    <p className="tw-text-gray">
                      Every asylum seeker’s case is reviewed individually, with
                  ...
                  <div>
                    ...
                    <ul className=" tw-p-0 tw-pl-0">
                      <li>
                        <p className=" m-0 tw-text-gray">
                          You must be physically in Sweden or at the Swedish
                          border to apply for asylum.
                        </p>
                      </li>
                    </ul>
                    ...
                    <ul className=" tw-p-0 tw-pl-0">
                      <li>
                        <p className=" m-0 tw-text-gray">
                          If you select us as your representative, we will be
                    ...
                    <ul className=" tw-p-0 tw-pl-0">
                      <li>
                        <p className=" m-0 tw-text-gray">
                          We provide ongoing support and legal advice to ensure
                    ...
                    <ul className=" tw-p-0 tw-pl-0">
                      <li>
                        <p className=" m-0 tw-text-gray">
                          Your family may be eligible for family reunification
                    ...
                    <ul className=" tw-p-0 tw-pl-0">
                      <li>
                        <p className=" m-0 tw-text-gray">
                          If you are an EU/EEA citizen, you may benefit from a
                    ...
                    <ul className=" tw-p-0 tw-pl-0">
                      <li>
                        <p className=" m-0 tw-text-gray">
                          We assist with preparing and submitting the residence
                    ...
                    <ul className=" tw-p-0 tw-pl-0">
                      <li>
                        <p className=" m-0 tw-text-gray">
                          In addition to asylum and family reunification, we
