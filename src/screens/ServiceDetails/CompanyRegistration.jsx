            ...
            <div className="row g-4">
              <div className="col-md-8 tw-py-20 tw-bg-white">
                ...
                <h2>
                  ...
                  <p className=" tw-text-gray">You can do business in different ways inside Sweden. Whether you can start your own business or become a partner with one or more other Firms/Corporations.Company Registration</p>
                  <p className=" tw-text-gray">You can do business in different ways inside Sweden. Whether you can start your own business or become a partner with one or more other Firms/Corporations.</p>
                  <div className=" row">
                  ...
                  <ul className=" tw-p-0 tw-pt-4">
                    <li className=" tw-flex tw-items-center tw-gap-3">
                      ...
                      <p className=" m-0 tw-text-gray">Sole Trader (Enskild Firma)</p>
                    </li>
                    <li className=" tw-flex tw-items-center tw-gap-3">
                      <GoTriangleRight className=" tw-text-blue" />
                      <p className=" m-0 tw-text-gray">Trading Partnership or Limited Partnership (Handelsbolag/Kommanditbolag)</p>
                    </li>
                    <li className=" tw-flex tw-items-center tw-gap-3">
                      <GoTriangleRight className=" tw-text-blue" />
                    ...
                    <li className=" tw-flex  tw-gap-3">
                      <GoTriangleRight className=" tw-text-blue" />
                      <p className=" m-0 tw-text-gray">Limited Company (Aktiebolag)</p>
                    </li>

                    <li className=" tw-flex  tw-gap-3">
                      <GoTriangleRight className=" tw-text-blue" />
                      <p className=" m-0 tw-text-gray">Economic Association/cooperative (Ekonomisk Förening)</p>
                    </li>
                  </ul>

                  <p className=" tw-text-gray">Non-Profit Associations and foundations also engage in business activities, although they are usually not started up for this purpose.</p>

                  <p className=" tw-text-gray">If you are planning to register your company inside Sweden, you can reach us anytime if you have some queries about it.</p>
                  <p className=" tw-text-gray">
                    We have different packages for your new and existing business that includes website creation, data entry software, invoicing software, and mobile applications. The pricing of our offered packages will be according to the size of
                    the company.
                  </p>
                </div>
              </div>
