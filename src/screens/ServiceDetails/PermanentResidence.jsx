                ...
                <div className="  md:tw-pl-32 tw-pl-3">
                  ...
                  <div>
                    ...
                    <p className=" tw-text-gray">
                      ...
                      There are quite a few permits that can lead to permanent residence. Generally, you just need to spend enough time on one of the following permits.
                    </p>
                    <p className=" tw-text-gray tw-font-medium">Some of these are:</p>

                    <ul className=" tw-p-0 tw-pt-4">
                      <li className=" tw-flex tw-items-center tw-gap-3">
                        <GoTriangleRight className=" tw-text-blue" />
                        <p className=" m-0 tw-text-gray">Standard work permit</p>
                      </li>
                      <li className=" tw-flex tw-items-center tw-gap-3">
                        <GoTriangleRight className=" tw-text-blue" />
                    ...
                    <p className=" tw-text-gray">Time spent in Sweden on a student permit or on a working holiday visa does not generally count towards the time needed for permanent residence.</p>

                    <p className=" tw-text-gray">Standard work permit, EU blue card, guest researcher, and doctoral students</p>
                    <p className=" tw-text-gray">
                      The process for obtaining permanent residence as someone holding a standard work permit, EU blue card, guest researcher, and doctoral student are relatively similar. In order to obtain permanent residence the core requirement is
                      to have held a permit for a combined period of 4 years in Sweden (excluding time spent on student permits) during the past 7 years. The assessment of permanent residence will be made in conjunction with the extension application
                  ...
                  <div>
                    ...
                    <p className=" tw-text-gray">
                      ...
                      or if the main applicant/reference person in Sweden already has permanent residence. They cannot be granted permanent residence on their own merits as a dependent and require the main application to be granted this first
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className=" tw-p-0 tw-pt-4">
                      <li className=" tw-flex tw-items-center tw-gap-3">
                        <GoTriangleRight className=" tw-text-blue" />
                        <p className=" m-0 tw-text-gray">You should have lived in Sweden for at least five years while having a relation to the close relative who is an EU citizen</p>
                      </li>
                      <li className=" tw-flex tw-items-center tw-gap-3">
                        <GoTriangleRight className=" tw-text-blue" />
                        <p className=" m-0 tw-text-gray">Your family member should meet the requirements of permanent right of residence.</p>
                      </li>
                    </ul>

                    <p className="  tw-text-gray">
                      Your permanent right of residence is dependent on your family member who is an EU citizen having the right of residence for five years. Your application should specify the occupation of the EU citizen.
                    </p>
                    <p className="  tw-text-gray">There are also special regulations about keeping your right of residence in certain cases. Contact us for more details.</p>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className=" tw-p-0 tw-pt-4">
                      ...
                      <li className=" tw-flex tw-items-center tw-gap-3">
                        <GoTriangleRight className=" tw-text-blue" />
                        <p className=" m-0 tw-text-gray">To vote in the national elections</p>
                      </li>
                      <li className=" tw-flex tw-items-center tw-gap-3">
                        <GoTriangleRight className=" tw-text-blue" />
                        <p className=" m-0 tw-text-gray">Nor does it entitle you to do the military service or to exercise any military occupations</p>
                      </li>
                    </ul>
