              ...
              <div className="col-md-8 tw-py-20 tw-bg-white">
                <div className="  md:tw-pl-32 tw-pl-3">
                  ...
                  <div className="row tw-flex tw-items-center tw-mb-6">
                      ...
                      <p className=" tw-text-gray">
                    You can get refused when entering the UK without a permit. You can apply for the EU card which is valid for 5 years, once you are in the UK. The residence card makes it easier for a person to work in the UK. However, The extended
                    family has to apply for a residence card.
                  </p>
                  ...
                  <div>
                    ...
                    <p className=" tw-text-gray">
                      ...
                      possible when your EU family member is working, studying, or running a business. Although you should have complete health insurance.
                    </p>
                  </div>
                  <div>
                    <div>
                      ...
                      <p className=" tw-text-gray ">
                        ...
                        or his spouse) can be taken as family at any age if they can prove to be financially dependant on the EU sponsor.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className=" tw-text-gray ">
                        ...
                        2 years, brother, sister, aunt, uncle, cousin, or niece.
                      </p>
                      <p className=" tw-text-gray ">
                    ...
                    <div>
                      ...
                      <ul className=" tw-p-0 tw-pt-4">
                        <li className=" tw-flex tw-items-center tw-gap-3">
                          ...
                          <p className=" m-0 tw-text-gray">The primary caretaker of an EEA child in the UK, and financially independent.</p>
                        </li>
                        <li className=" tw-flex tw-items-center tw-gap-3">
                          <GoTriangleRight className=" tw-text-blue" />
                          <p className=" m-0 tw-text-gray">A child of an EEA former worker and you are currently in education in the UK.</p>
                        </li>
                        <li className=" tw-flex tw-items-center tw-gap-3">
                          <GoTriangleRight className=" tw-text-blue" />
                          <p className=" m-0 tw-text-gray">The primary caretaker of a child of an EEA former worker. This child is currently in education in the UK.</p>
                        </li>
                        <li className=" tw-flex  tw-gap-3">
                          <GoTriangleRight className=" tw-text-blue" />
                          <p className=" m-0 tw-text-gray">A primary caretaker of a British child.</p>
                        </li>

                        <li className=" tw-flex  tw-gap-3">
                          <GoTriangleRight className=" tw-text-blue" />
                          <p className=" m-0 tw-text-gray">The primary caretaker of a British dependent adult; or</p>
                        </li>
                        <li className=" tw-flex  tw-gap-3">
                          <GoTriangleRight className=" tw-text-blue" />
                          <p className=" m-0 tw-text-gray">A child of a primary caretaker who qualifies through one of these categories.</p>
                        </li>
                      </ul>

                      <p className=" m-0 tw-text-gray">The Home Office defines the primary caretaker as someone who has the responsibility for the day-to-day care of the person. This includes decision-making about education, health, and finance.</p>
                      <p className=" m-0 tw-text-gray">
                        The primary caretaker must be a family member or the legal guardian. This person can be the main caretaker or can share the responsibility with someone else. You must fulfill very strict requirements to qualify under this
                        route.
                      </p>
                    ...
                    <div>
                      ...
                      <ul className=" tw-p-0 tw-pt-4">
                        <li className=" tw-flex tw-gap-3">
                          ...
                          <p className=" m-0 tw-text-gray">Your marriage or civil partnership to that person has ended due to a divorce, annulment or dissolution.</p>
                        </li>
                        <li className=" tw-flex  tw-gap-3">
                          <div>
                            <GoTriangleRight className=" tw-text-blue" />
                          </div>
                          <p className=" m-0 tw-text-gray">The person died, and you have lived in the UK for at least one year before their death.</p>
                        </li>
                        <li className=" tw-flex  tw-gap-3">
                          <div>
                            <GoTriangleRight className=" tw-text-blue" />
                          ...
                          <p className=" m-0 tw-text-gray">
                            You are the child of an EEA national who has died or left the UK. Or you are the child of their spouse or civil partner, or former spouse or civil partner, and you were in education when that person left the UK or died,
                            and you continue to be in education.
                          </p>
                        </li>
                        <li className=" tw-flex  tw-gap-3">
                          <div>
                          ...
                          <p className=" m-0 tw-text-gray">You are the parent and have custody, of a child who has a retained right of residence because they are in education in the UK.</p>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div>
                      ...
                      <ul className=" tw-p-0 tw-pt-4">
                        <li className=" tw-flex tw-gap-3">
                          ...
                          <p className=" m-0 tw-text-gray">The civil partnership or marriage lasted 3 years before legal proceedings began. The couple lived in the UK for at least 1 year before the divorce, annulment or dissolution was finalized.</p>
                        </li>
                        <li className=" tw-flex  tw-gap-3">
                          <div>
                            <GoTriangleRight className=" tw-text-blue" />
                          </div>
                          <p className=" m-0 tw-text-gray">You have custody of a child of the relevant EEA national.</p>
                        </li>
                        <li className=" tw-flex tw-items-center tw-gap-3">
                          <div>
                            <GoTriangleRight className=" tw-text-blue" />
                          </div>
                          <p className=" m-0 tw-text-gray">You have access rights to the child of the relevant EEA national. The judge ordered access to the child in the UK, and the child is younger than 18 years of age.</p>
                        </li>
                        <li className=" tw-flex  tw-gap-3">
                          <div>
                            <GoTriangleRight className=" tw-text-blue" />
                          </div>
                          <p className=" m-0 tw-text-gray">You, or a family member, have been a victim of domestic violence during the marriage or civil partnership.</p>
                        </li>
                        <li className=" tw-flex  tw-gap-3">
                          <div>
                            <GoTriangleRight className=" tw-text-blue" />
                          </div>
                          <p className=" m-0 tw-text-gray">Any other particularly difficult circumstances that will justify the retaining right of residence.</p>
                        </li>
                        <li className=" tw-flex  tw-gap-3">
                          <div>
                            <GoTriangleRight className=" tw-text-blue" />
                          </div>
                          <p className=" m-0 tw-text-gray">Indefinite Leave to Remain in the UK and the EEA Family Permit</p>
                        </li>
                      </ul>
