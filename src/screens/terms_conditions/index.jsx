        ...
        <div className="container tw-pb-5 tw-text-justify">
          <div className="row">
            <div className="col-md-12">
              <h5>{t(`1. Team and Services`)}</h5>

              <p className=" tw-pt-3 tw-text-gray m-0">
                <strong>{t(`1.1`)}</strong>{t(` We work in teams to offer you the
              ...
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`1.2`)}</strong>{t(` In order to develop personal
                ...
                advisory advice on what you will get on your client portal.`)}
              </p>
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`1.3`)}</strong> {t(`According to the assigned
              ...
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`1.4`)}</strong>{t(` In accordance with these terms, all
              ...
              <h5>{t(`2. ARRANGEMENTS AND COSTS`)}</h5>

              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`2.1`)}</strong>{t(` We strive to provide services for
              ...
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`2.2`)}</strong> {t(`If we do not agree on a fixed
                ...
                pressure and (vi) achieved results.`)}
              </p>
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`2.3`)}</strong> {t(`In addition to our fees, travel and
                ...
                extra on top of the already paid invoice.`)}
              </p>
              ...
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`3.1`)}</strong> {t(`One-time invoices for assignments or
              ...
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`3.2`)}</strong> {t(`For those clients who choose the
              ...
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`3.3`)}</strong>{t(`In some cases, we will request
              ...
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`3.4`)}</strong>{t(`At The latest you have to pay the
                ...
                invoices will be issued through, Visma or Profina.`)}
              </p>
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`3.5`)}</strong>{t(`We will not charge a late payment for
                ...
                under the Swedish Interest Act.`)}
              </p>

              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`3.6`)}</strong>{t(`You can find all your documents,
              ...
              <h5>{t(`4. IDENTIFICATION OF CUSTOMERS`)}</h5>

              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`4.1`)}</strong> {t(`For certain assignments, we must
                ...
                also be asked for references.`)}
              </p>
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`4.2`)}</strong> {t(`For Family relocation services we
                will keep all the family documents, which we might need in the
                future to communicate to the authorities on your behalf.`)}
              </p>
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`4.3`)}</strong>{t(`On our online portal you can upload
                ...
                the office and they will remove it from the backend.`)}
              </p>

              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`4.4`)}</strong>{t(`We will only provide ongoing
              ...
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`4.5`)}</strong>{t(`According to the new GDPR law we
                ...
                delete your data but keep the profile for the latest updates.`)}
              </p>
              ...
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`5.1`)}</strong> {t(`When we advise you so it is specific
              ...
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`5.2`)}</strong>{t(`Our advisors can only advise on the
                ...
                advice which has been given in the past.`)}
              </p>
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`5.3`)}</strong>{t(`We will not record any audio video
                ...
                specific purpose you need written approval from the company.`)}
              </p>

              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`5.4`)}</strong>{t(`We are not lawyers but consultants
              ...
              <h5>{t(`6. LIMTATION OF LIABLITY`)}</h5>

              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`6.1`)}</strong> {t(`In addition to the limitations of
              ...
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`6.2`)}</strong>{t(`Once we got the Power of
                ...
                will not be responsible for any further proceedings.`)}
              </p>
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`6.3`)}</strong>{t(`We advise our clients according to
              ...
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`6.4`)}</strong>{t(`We would not be answerable to any
              ...
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`6.5`)}</strong>{t(`No time frame will be provided by us,
              ...
              <p className=" tw-text-gray m-0 tw-pt-3">
                <strong>{t(`6.6`)}</strong>{t(`We are using an online portal and
