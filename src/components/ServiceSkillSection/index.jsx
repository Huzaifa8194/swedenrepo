...
import video1 from "../../assets/iconscout/Sweden Relocators_English_Origanal2.mp4"
          ...
          <div className="col-xl-6 col-lg-6 col-md-12 col-xs-12">
            <div className="pl-15 mt-15 text-left res-991-pl-0 res-991-mt-15">
              ...
              <div className="section-title">
                ...
                <p className="tw-text-gray">To get started, we recommend using our <strong>assessment tool</strong> to check your basic eligibility. Let us simplify your journey!</p>
